...
@section('breadcrumbs')
    <li class="breadcrumb-item"><a href="{!!route('backend.dashboard')!!}"><i class="icon-speedometer"></i>
            Dashboard</a></li>
    <li class="breadcrumb-item"><a href='{!!route("backend.$module_name.index")!!}'><i
                    class="{{ $module_icon }}"></i> {{ $module_title }}</a></li>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div class="float-right">
                        <a href="{{ route("backend.users.profileEdit") }}" class="btn btn-primary mt-1 btn-sm"
                           data-toggle="tooltip" title="Edit {{ str_singular($module_name) }} "><i
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            <tr>
                                ...
                                <td><img src="{{ asset('photos/avatars/'.$user->avatar) }}"
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('backend.users.changeProfilePassword') }}"
