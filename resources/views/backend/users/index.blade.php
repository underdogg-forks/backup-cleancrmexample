            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div class="float-right">
                        <a href="{{route('backend.users.create')}}" class="btn btn-success ml-1" data-toggle="tooltip"
                        ...
                        @foreach ($users as $user)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="{{route('backend.users.block', $user)}}" class="btn btn-danger btn-sm mt-1"
                                       data-method="PATCH" data-token="{{csrf_token()}}" data-toggle="tooltip"
                                       title="{{__('labels.backend.block')}}" data-confirm="Are you sure?"><i
                                                class="fas fa-ban"></i></a>
                                    <a href="{{route('backend.users.unblock', $user)}}" class="btn btn-info btn-sm mt-1"
                                       data-method="PATCH" data-token="{{csrf_token()}}" data-toggle="tooltip"
