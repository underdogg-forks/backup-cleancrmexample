            ...
            <div class="row">
                ...
                <div class="col-4">
                    <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                        <a href="{{route("backend.$module_name.create")}}" class="btn btn-success ml-1"
                           data-toggle="tooltip" title="Create New"><i class="fas fa-plus-circle"></i></a>
                    </div>
                </div>
                <!--/.col-->
            </div>
                            ...
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <a href="{{route("backend.$module_name.edit", $module_name_singular)}}"
                                       ...
                                       title="{{__('labels.backend.edit')}}"><i class="fas fa-pencil-alt"></i></a>
                                </td>
                            </tr>
                        @endforeach
                        </tbody>
