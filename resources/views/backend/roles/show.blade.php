                ...
                <div class="col-4">
                    <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                        ...
                        <a href="{{route("backend.$module_name.edit", $$module_name_singular)}}"
                           class="btn btn-primary ml-1" data-toggle="tooltip" title="{{__('labels.backend.edit')}}"><i
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tr>
                                ...
                                <td>{{ $$module_name_singular->created_at }}<br>
                            ...
                            <tr>
                                ...
                                <td>{{ $$module_name_singular->updated_at }}<br/>
